...
extendArray();
var locationMatrix = {
 location: Array.matrix(boardSize,boardSize,0)
}
...
var setID = (function() {
   return function (x,y){ 
            ...
            locationMatrix.location[x][y] = blockID;     
...
var getID = function(x,y) {
  ...
  return locationMatrix.location[x][y];
...
function createGrid() {
    ...
    {
        cli_msg.text("A miss, interesting choice by the opponent");
        setTimeout(function(){
            cli_msg.text("");
          }
          ,2000); 
    ...
    case SBConstants.GAME_OVER_EVENT:
        ...
        cli_msg.text("Game over. You are the loser. The weakest link. I am sorry")
        setTimeout(function()
        {
          $('body').empty();
        $('body').addClass('winner');
        cli_msg.addClass('winner');
        ...
        {
           cli_msg.text("Draw, gotta be quicker than that");
        }
        break;
    }
   ...
   var elementID = locationMatrix.location[x][y];
